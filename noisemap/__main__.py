...
def main():
    parser = argparse.ArgumentParser(description="Compute noise map from a NIfTI image using ANLM.")
    ...
    # Only ANLM is supported
    parser.add_argument("-m", "--method", type=str, default='anlm', choices=['anlm'], help="Estimation method (only 'anlm' supported)")
    args = parser.parse_args()

    # Splash text
    print("\nNoisemap: Rician MRI Noise Map Estimation (ANLM only)")
    print("-" * 40)
